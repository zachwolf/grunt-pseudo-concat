...
> require-esk script includes for debugging files that will be concatenate. It replaces your compiled script with a file loader, allowing you to debug individual files without structure changes.
